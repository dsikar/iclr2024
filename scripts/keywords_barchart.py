...
def main():
    ...
    num_keywords_to_display = 75

    # Extract titles for each year
    titles_2020 = extract_titles_from_file('iclr2020.txt')
    titles_2021 = extract_titles_from_file('iclr2021.txt')
    titles_2022 = extract_titles_from_file('iclr2022.txt')
    titles_2023 = extract_titles_from_file('iclr2023.txt')
